...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("The Very Hungry Caterpillar", 5.5f, "USD",
                ...
                kids, hachette));
        productDataStore.add(new Product("Goodnight Moon", 5.65f, "USD",
        ...
        productDataStore.add(new Product(
                "The Montessori Baby: A Parent's Guide to Nurturing Your Baby with Love", 10.35f, "USD",
        ...
        productDataStore.add(new Product(
                ...
                parents, penguin));
        productDataStore.add(new Product("No-Drama Discipline", 11.86f, "USD",
